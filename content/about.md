...
## a running/cycling club (without the spandex)

Our goal is to encourage men from the greater Macedon Shire and surrounds to join us on events such as {{< colour class="text-link" >}}**hiking**, **rucking**, **overnight camping**{{< /colour >}} and more, as a means to detox from the virtual world. Members will gain invaluable skills, physical strength, cardio, and friendships that will last a lifetime. We aim to give young men a chance to discuss problems, {{< colour class="text-link" >}}**learn to overcome challenges**{{< /colour >}} and persevere in a world that can seem very isolating.
